...
//export_php: testFunc(string $name): string
...
//export_php: func1(int $a): int
func func1(a long) *go_value {
	return Int(a * 2)
}

//export_php: func2(string $b): string  
...
//export_php: phpFunc(string $data): string
...
//export_php: anotherPhpFunc(int $num): int
...
//export_php: phpFunc(data string): string
func phpFunc(data *go_string) *go_value {
	return String("PHP: " + CStringToGoString(data))
}`,
			expected: 0,
